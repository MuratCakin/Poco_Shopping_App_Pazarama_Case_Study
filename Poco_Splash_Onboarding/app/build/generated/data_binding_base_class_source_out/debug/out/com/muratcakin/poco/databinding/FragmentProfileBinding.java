...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSignOut,
      ...
      @NonNull TextView tvEmail, @NonNull TextView tvPassword, @NonNull TextView tvUsername) {
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((ConstraintLayout) rootView, btnSignOut, linearLayout,
          materialCardView, tvEmail, tvPassword, tvUsername);
    }
