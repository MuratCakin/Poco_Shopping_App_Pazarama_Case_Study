...
class SignUpFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.etUsernameSignUp.setOnKeyListener { view, keyCode, _ -> handleKeyEvent(view, keyCode)}
        binding.etEmailSignUp.setOnKeyListener { view, keyCode, _ -> handleKeyEvent(view, keyCode)}
        binding.etPasswordSignUp.setOnKeyListener { view, keyCode, _ -> handleKeyEvent(view, keyCode)}
        binding.etConfirmPasswordSignUp.setOnKeyListener { view, keyCode, _ -> handleKeyEvent(view, keyCode)}
